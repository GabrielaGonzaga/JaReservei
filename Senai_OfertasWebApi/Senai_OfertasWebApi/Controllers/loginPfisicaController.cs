    ...
    public class loginPfisicaController : ControllerBase {
        ...
        public IActionResult Post(LoginViewModel login)
        {
            try
            {
                ...
                Pfisica PfisicaBuscado = _PfisicaRepository.Login(login.Email, login.Senha);

                // Caso não encontre nenhum usuário com o e-mail e senha informados
                if (PfisicaBuscado == null)
                {
                ...
                */
                ...
                var claims = new[]
                {
                    ...
                    new Claim(JwtRegisteredClaimNames.Email, PfisicaBuscado.Email),

                    // Armazena na Claim o ID do usuário autenticado
                    new Claim(JwtRegisteredClaimNames.Jti, PfisicaBuscado.IdPfisica.ToString())
                };
